...
const BottomStrip = () => {
  ...
  const toggleChatDrawer = (value: boolean) => {
    ...
    <>
      <div className="fixed bottom-0 z-[2] w-full bg-white px-4 py-[6px] lg:w-[81%]">
        <div className="flex justify-end gap-3 ">
          <Link
            href="#"
            className="relative flex h-6 w-6 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
          >
            <span
