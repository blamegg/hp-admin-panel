...
const defaultSvg = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M9 1L1 9H3V17H7V11H11V17H15V9H17L9 1Z" fill="currentColor" />
  </svg>
);
...
const menuItems = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M9 9C7.34315 9 6 10.3431 6 12C6 13.6569 7.34315 15 9 15C10.6569 15 12 13.6569 12 12C12 10.3431 10.6569 9 9 9Z"
          fill="currentColor"
        />
        <path
          d="M1 17C1 14.7909 3.79086 13 9 13C14.2091 13 17 14.7909 17 17H1Z"
          fill="currentColor"
        />
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12 1C11.4477 1 11 1.44772 11 2C11 2.55228 11.4477 3 12 3C12.5523 3 13 2.55228 13 2C13 1.44772 12.5523 1 12 1Z"
          fill="currentColor"
        />
        <path
          d="M2 2H4C4.55228 2 5 2.44772 5 3V15C5 15.5523 4.55228 16 4 16H2C1.44772 16 1 15.5523 1 15V3C1 2.44772 1.44772 2 2 2Z"
          fill="currentColor"
        />
        <path
          d="M14 2H16C16.5523 2 17 2.44772 17 3V15C17 15.5523 16.5523 16 16 16H14C13.4477 16 13 15.5523 13 15V3C13 2.44772 13.4477 2 14 2Z"
          fill="currentColor"
        />
      </svg>
    ),
